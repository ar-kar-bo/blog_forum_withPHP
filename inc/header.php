            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="user_edit.php?user=<?php echo User::auth()->slug;?>">Welcome <?php echo User::auth()->name;?></a>
                ...
                <?php
                        ...
                        ?>
                <li class="nav-item">
                        <a class="nav-link" href="index.php?your_article">Your Articles</a>
                </li>
        ...
        <div class="row">
            <div class="col-md-4 pr-3 pl-3">
                ...
                <div class="card card-dark">
                    ...
                    <div class="card-body">
                        <?php
                        $language = DB::raw("SELECT *,(SELECT COUNT(id) FROM article_languages WHERE languages.id = article_languages.language_id ) AS article_count FROM languages")->get();
                        ?>
                        <ul class="list-group">
                            <?php
